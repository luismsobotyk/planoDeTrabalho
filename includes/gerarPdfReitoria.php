...
function geraPdf($id){
	...
	<table style="width:100%; border-collapse: collapse;">'.$txtEnsino.'
	</table>';
	...
	<table style="width:100%; border-collapse: collapse;">'.$txtPesquisa.'
	</table>';
	...
	<table style="width:100%; border-collapse: collapse;">'.$txtExtensao.'
	</table>';
	...
	$dompdf->load_html('
		...
		<body>
		<i style="float: right; margin-top:10px;">2018/2</i>
	...
	// salva no servidor
	file_put_contents('saveArchives/2018-02 - Plano de Trabalho - '.$identificacao[0]["nome"].".pdf", $output);
}
...
function downloadPdf($id){
	$identificacao= getIdentificacao($id);
	$arquivoNome= "2018-02 - Plano de Trabalho - ".$identificacao[0]["nome"].".pdf";
	...
	$novoNome = "2018-02 - Plano de Trabalho - ".$identificacao[0]["nome"].".pdf";
